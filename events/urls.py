...
urlpatterns = [
    ...
    path('api/method-distribution/', views.get_method_distribution, name='method_distribution'),
    path('api/historical-method-data/', views.get_historical_method_data, name='historical_method_data'),
] 
